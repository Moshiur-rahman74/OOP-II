...
def add_expense(category, amount, description):
    ...
    if total > 100000:
        print("ALERT: Total expenses have exceeded the limit of 100,000!")
...
def view_expenses():
    ...
    for i, expense in enumerate(expenses):
        print(
            f"Index: {i}, Category: {expense['category']}, Amount: {expense['amount']}, Description: {expense['description']}, Date: {expense['date']}")
...
def search_expenses(category):
    ...
    for expense in expenses:
        if expense['category'].lower() == category.lower():
            print(
                f"Category: {expense['category']}, Amount: {expense['amount']}, Description: {expense['description']}, Date: {expense['date']}")
            found = True
    if not found:
